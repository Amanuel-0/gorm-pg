...
func seedBooks(db *gorm.DB, ctx context.Context, users []models.User, authors []models.Author, genres []models.Genre) ([]models.Book, error) {
	...
	books := []models.Book{
		...
		{OwnerID: users[0].ID, Title: "1984", AuthorID: &authors[1].Model.ID, Language: "EN", Condition: "like_new", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("California"), LocationCity: stringPtr("San Francisco")},
		{OwnerID: users[1].ID, Title: "Foundation", AuthorID: &authors[0].Model.ID, Language: "EN", Condition: "good", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("New York"), LocationCity: stringPtr("New York City")},
		{OwnerID: users[2].ID, Title: "Frankenstein", AuthorID: &authors[2].Model.ID, Language: "EN", Condition: "acceptable", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("Texas"), LocationCity: stringPtr("Houston")},
		{OwnerID: users[0].ID, Title: "Harry Potter and the Philosopher's Stone", AuthorID: &authors[3].Model.ID, Language: "EN", Condition: "new", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("California"), LocationCity: stringPtr("Los Angeles")},
		{OwnerID: users[1].ID, Title: "The Shining", AuthorID: &authors[4].Model.ID, Language: "EN", Condition: "like_new", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("Florida"), LocationCity: stringPtr("Miami")},
		{OwnerID: users[3].ID, Title: "Murder on the Orient Express", AuthorID: &authors[5].Model.ID, Language: "EN", Condition: "good", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("CA"), LocationState: stringPtr("Ontario"), LocationCity: stringPtr("Toronto")},
		{OwnerID: users[4].ID, Title: "Pride and Prejudice", AuthorID: &authors[6].Model.ID, Language: "EN", Condition: "like_new", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("AU"), LocationState: stringPtr("New South Wales"), LocationCity: stringPtr("Sydney")},
		{OwnerID: users[0].ID, Title: "Great Expectations", AuthorID: &authors[7].Model.ID, Language: "EN", Condition: "acceptable", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("California"), LocationCity: stringPtr("San Francisco")},
		{OwnerID: users[2].ID, Title: "The Adventures of Tom Sawyer", AuthorID: &authors[8].Model.ID, Language: "EN", Condition: "good", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("Texas"), LocationCity: stringPtr("Austin")},
		{OwnerID: users[1].ID, Title: "The Old Man and the Sea", AuthorID: &authors[9].Model.ID, Language: "EN", Condition: "like_new", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("New York"), LocationCity: stringPtr("Buffalo")},
		{OwnerID: users[3].ID, Title: "The Great Gatsby", AuthorID: &authors[10].Model.ID, Language: "EN", Condition: "new", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("Florida"), LocationCity: stringPtr("Orlando")},
		{OwnerID: users[4].ID, Title: "To Kill a Mockingbird", AuthorID: &authors[11].Model.ID, Language: "EN", Condition: "good", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("AU"), LocationState: stringPtr("Victoria"), LocationCity: stringPtr("Melbourne")},
		{OwnerID: users[0].ID, Title: "Beloved", AuthorID: &authors[12].Model.ID, Language: "EN", Condition: "like_new", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("California"), LocationCity: stringPtr("San Francisco")},
		{OwnerID: users[2].ID, Title: "One Hundred Years of Solitude", AuthorID: &authors[13].Model.ID, Language: "EN", Condition: "good", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("Texas"), LocationCity: stringPtr("Houston")},
		{OwnerID: users[1].ID, Title: "The Unbearable Lightness of Being", AuthorID: &authors[14].Model.ID, Language: "EN", Condition: "acceptable", AvailableFrom: &now, Active: true, LocationCountry: stringPtr("US"), LocationState: stringPtr("New York"), LocationCity: stringPtr("New York City")},

		// Some archived books for soft delete testing
		{OwnerID: users[0].ID, Title: "Archived Book 1", AuthorID: &authors[0].Model.ID, Language: "EN", Condition: "good", AvailableFrom: &now, Active: false, ArchivedAt: timePtr(now.AddDate(0, 0, -10)), LocationCountry: stringPtr("US"), LocationState: stringPtr("California"), LocationCity: stringPtr("San Francisco")},
		{OwnerID: users[1].ID, Title: "Archived Book 2", AuthorID: &authors[1].Model.ID, Language: "EN", Condition: "like_new", AvailableFrom: &now, Active: false, ArchivedAt: timePtr(now.AddDate(0, 0, -5)), LocationCountry: stringPtr("US"), LocationState: stringPtr("New York"), LocationCity: stringPtr("New York City")},
	}
